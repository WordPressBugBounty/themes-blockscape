...
License 	: CC0 1.0 Universal (CC0 1.0)
License URI	: https://pxhere.com/en/license,
Source 		: https://pxhere.com/en/photo/393220
...
License 	: CC0 1.0 Universal (CC0 1.0)
License URI	: https://pxhere.com/en/license,
Source 		: https://pxhere.com/en/photo/1187469

License 	: CC0 1.0 Universal (CC0 1.0)
License URI	: https://pxhere.com/en/license,
Source 		: https://pxhere.com/en/photo/718640

License 	: CC0 1.0 Universal (CC0 1.0)
License URI	: https://pxhere.com/en/license,
Source 		: https://pxhere.com/en/photo/570625
...
License 	: CC0 1.0 Universal (CC0 1.0)
License URI	: https://pxhere.com/en/license,
Source 		: https://pxhere.com/en/photo/1652045
...
The logo shown in the screenshot is self-created.
All other self made assets including logo are licensed under GPL-3.0-or-later.

© Copyright Blockscape 2023, Blockscape.

== Changelog ==

= 1.0.3 - March 14, 2024 =
    * New Feature: Six new style variations has been added.
    * Fix: Accessibility issue has been fixed.
    * Update: Made Compatible with latest WooCommerce blocks.
    * Fix: Design bug has been fixed.

= 1.0.2 - May 02, 2023 =
    * Fix: Body background and color attribute added
    * Fix: Replaced page list block with navigation in the footer

= 1.0.1 - April 28, 2023 =
    * Fix: Console error has been fixed
